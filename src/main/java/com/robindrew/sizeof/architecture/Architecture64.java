...
/**
 * The 64-bit JVM architecture.
 */
public class Architecture64 implements IArchitecture {
	...
	public static final int SIZE_OF_NULL_POINTER = 8;
	/** The number of bytes used to represent an object (with no fields). */
	public static final int SIZE_OF_OBJECT_INSTANCE = 16;
	...
	public static final int SIZE_OF_ARRAY = 24;
