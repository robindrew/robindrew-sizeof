...
/**
 * The default JVM architecture, 64-bit with compressed pointers.
 * <p>
 * This is default from "Java 6 update 23" (for heaps up to 32GB).
 */
public class Architecture64Compressed implements IArchitecture {
	...
	public static final int SIZE_OF_OBJECT_INSTANCE = 12;
